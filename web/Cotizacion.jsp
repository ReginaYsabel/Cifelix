                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" role="form" id="datos_cotizacion">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" id="empresa" placeholder="INGRESE DATOS">
                                </div>
                                <label for="tel2" class="col-md-1 control-label">Direccion:</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="tel2" placeholder="Direccion">
                                </div>
            ...
            <hr size="5px" color="black">     
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><%=d.getNom()%></td>
                                    <td><%=d.getPre()%></td>
                                    <td><a href="cotizacionController?op=menos&cod=<%=d.getCod()%>&nom=<%=d.getNom()%>&pre=<%=d.getPre()%>" class="btn btn-danger">-</a> <%=d.getCan()%> <a href="cotizacionController?op=mas&cod=<%=d.getCod()%>&nom=<%=d.getNom()%>&pre=<%=d.getPre()%>" class="btn btn-primary">+</a> </td>
